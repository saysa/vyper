							...
							<div class="col-lg-4">
								...
								<div class="row">
									<div class="form-group col-lg-9{%if error_name_real %} has-error{% endif %}">
										...
										<div class="controls">
										  <input class="form-control focused" id="name_real" name="name_real" type="text" placeholder="Name real" value="{{ post_name_real }}">
										  {{ error_name_real }}
										</div>
									</div>
								</div>
							...
							<div class="col-lg-4">
								...
								<div class="row">
									<div class="form-group col-lg-9{%if error_town %} has-error{% endif %}">
										...
										<div class="controls">
										  <input class="form-control focused" id="town" name="town" type="text" placeholder="Town" value="{{ post_town }}">
										  {{ error_town }}
										</div>
									</div>
								</div>
							...
							<div class="col-lg-4">
								...
								<div class="row">
									<div class="form-group col-lg-9{%if error_town_real %} has-error{% endif %}">
										...
										<div class="controls">
										  <input class="form-control focused" id="town_real" name="town_real" type="text" placeholder="Town real" value="{{ post_town_real }}">
										  {{ error_town_real }}
										</div>
									</div>
								</div>	
							...
							<div class="col-lg-4">
								...
								<div class="row">
									<div class="form-group col-lg-9{%if error_url %} has-error{% endif %}">
										...
										<div class="controls">
										  <input class="form-control focused" id="url" name="url" type="text" placeholder="URL" value="{{ post_url }}">
										  {{ error_url }}
										</div>
									</div>
								</div>
