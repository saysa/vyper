...
return ($database instanceof Framework\Database\Connector\Pdo);
},
...
return ($query instanceof Framework\Database\Query\Pdo);
},
...
$database = $database->connect();
$query = $database->query();
return ($query->connector instanceof Framework\Database\Connector\Pdo);
},
